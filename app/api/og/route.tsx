...
// Use Node.js runtime - Edge doesn't support Node's crypto module used by dependencies (e.g. Zod)
        ...
        >
          <div
            ...
            style={{
              ...
              fontWeight: "normal",
              position: "relative",
              background: "linear-gradient(90deg, #3ECF8E, #2DD4BF 80%)",
              backgroundClip: 'text',
              color: 'transparent'
            }}
          >
          ...
          <div tw="flex items-center w-full justify-between">
            ...
            >
              ...
              <div tw="flex flex-col" style={{ marginLeft: "15px" }}>
                ...
                <div>Open Source Customer Messaging</div>
              </div>
            </div>
            ...
            >
              ...
              <div tw="flex ml-2">github.com/guddesk/guddesk</div>
            </div>
          </div>
        </div>
      ),
